...
/* ?? null colasce */
$serieSeleccionada = $_GET['categoria'] ?? FALSE;

$productos = catalogo_x_objetos($serieSeleccionada);




$miTituloBonito = $serieSeleccionada ? ucwords(str_replace("_", " ", $serieSeleccionada)) : FALSE;

   /*  echo "La funcion Count , va contar los elementos: " . count($series)  . " Productos"; */

?>

<h1 class="text-center my-5 ">Productos  de <?=  $miTituloBonito ?> </h1>
